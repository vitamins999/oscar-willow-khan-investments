      ...
      <div className='container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col'>
        ...
        <p className='text-xs sm:text-sm text-gray-900 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-700 sm:py-2 sm:mt-0 mt-4 text-center'>
          ...
          <a
            ...
            className='text-gray-700 ml-1 hover:text-gray-900 transition duration-200 ease-in-out'
        ...
        <span className='inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start'>
          <a className='text-gray-900 hover:text-gray-700 transition duration-200 ease-in-out cursor-pointer'>
            <svg
              fill='currentColor'
              strokeLinecap='round'
          ...
          <a className='ml-3 text-gray-900 hover:text-gray-700 transition duration-200 ease-in-out cursor-pointer'>
            <svg
              fill='currentColor'
              strokeLinecap='round'
              strokeLinejoin='round'
